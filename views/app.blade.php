...
<body>
    <button type="button" id="createRoot" class="btn btn-primary mb-3">create root</button>
    <div class="content">
        {!! $nodes !!}
    </div>
</body>
...
function makeAncestry(name) {
    return `<ul style="list-style: none;">
                <li>
                    ...
                    <button type="button" class="btn btn-light btn-sm py-0 addNode">+</button>
                    <button type="button" class="btn btn-light btn-sm py-0 removeNode">-</button>
                </li>
            </ul>`;
};
